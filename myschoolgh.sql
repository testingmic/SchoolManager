...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 30, 2020 at 12:52 AM
...
INSERT INTO `events_types` (`id`, `client_id`, `item_id`, `name`, `description`, `icon`, `status`) VALUES
(1, 'LKJAFD94R', 'gIKkUqhAQtyWXcPCd6z5m0JYnMoaFxDu', 'First Type Updated', 'This is the first type of event that i am creating and insert. Great test', NULL, '1'),
(2, 'LKJAFD94R', 'WABbq4NLFRwStaOeXDQvsxrGZMCzf0gV', 'Second Event Test', 'This is the second event type. The next trial will be to list and update the event types that has already.', NULL, '1'),
(4, 'LKJAFD94R', 'miEKCQ5BwD20ovknlpUxXz4g78bAdRFj', 'Another one', 'This is the final test for the event type insertion', NULL, '1');
...
(114, 'v4yzw52dmfvsbjmfhsajoipqye63ollx', 'v1', 'events', 'events/add_type', 'POST', '', '{\"name\":\"required - The name of the type\",\"description\":\"Any additional description of the type\",\"icon\":\"The icon to be used to represent events that falls under this category\"}', 'active', 0, '2020-12-29 19:35:20', '2020-12-29 19:55:47', '0', '0', 'uIkajsw123456789064hxk1fc3efmnva', 'uIkajsw123456789064hxk1fc3efmnva'),
(115, '6d8roxdljhw2vnkwzb1et0yiahqqy4rl', 'v1', 'events', 'events/update_type', 'POST', '', '{\"name\":\"required - The name of the type\",\"description\":\"Any additional description of the type\",\"type_id\":\"required - The unique id of the type\",\"icon\":\"The icon to be used to represent events that falls under this category\"}', 'active', 0, '2020-12-29 19:35:47', '2020-12-29 19:55:52', '0', '0', 'uIkajsw123456789064hxk1fc3efmnva', 'uIkajsw123456789064hxk1fc3efmnva'),
