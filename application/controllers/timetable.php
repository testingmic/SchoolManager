...
class Timetable extends Myschoolgh {
    ...
    public function save(stdClass $params) {
        ...
        if($isFound) {
            ...
            ");
            $stmt->execute([$params->days, $params->slots, $params->duration, $params->start_time, json_encode($disabled_inputs)]);
        }
        // insert the record
        else {
            $stmt = $this->db->prepare("
        ...
        return ["code" => 200, "data" => "Timetable record was successfully saved."];
