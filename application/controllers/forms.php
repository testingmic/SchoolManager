...
class Forms extends Myschoolgh {
    ...
    public function settings_form($clientId, $form_id = "ajax-data-form-content") {
        ...
        <div class="row">
            ...
            <div class="col-lg-12"><h5 class="border-bottom border-primary text-primary pb-2 mb-3 pt-3">CURRENT ACADEMIC TERM</h5></div>
            <div class="col-lg-4 col-md-6">
                <div class="form-group">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="form-group">
                    <label for="term_ends">Term Name</label>
        ...
        $the_form["general"] .= "</select>
                    ...
                    <div class='col-lg-12 text-center'>
                        <div class='d-flex justify-content-center border-top mt-1 pt-3 gap-4'>
                            ...
                            <div class='hidden' data-option_id='upload_file' data-item_option='file_upload'>
                                <div class='hidden'>OR</div>
                                <div class='form-group mb-0'>
