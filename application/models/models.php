...
class Models {
    ...
    public function __construct() {
        ...
        $this->form_modules = [
            ...
            "course_lesson_form_comment" => "Interaction on Lesson Note",
            ...
            "load_delegate_form" => "Create Delegate",
            "update_delegate_form" => "Update Delegate",
        ...
        $this->features_list = [
            ...
            "exeats" => "Exeats Management",
            // "housing" => "Housing Management",
            // "sickbay" => "Sickbay Management",
