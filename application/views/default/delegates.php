        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-lg-12">
                <div class="text-right mb-2">
                    '.($hasAdd ? '
                        <div><button onclick="return load_quick_form(\'load_delegate_form\');" class="btn btn-outline-primary btn-sm" type="button"><i class="fa fa-user"></i> Create Delegate</button></div>' : ''
                    ).'
                </div>
                <div class="card">
                    <div class="card-body">
