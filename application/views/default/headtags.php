...
<head>
    ...
    <script src="<?= $baseUrl ?>assets/js/mixpanel.js" type="text/javascript"></script>
...
<body class="bg-gradient-to-br from-indigo-50 to-indigo-100">
    ...
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            <div class="navbar-bg fixed top-0 left-0 right-0 z-200 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white">
