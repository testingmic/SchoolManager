...
$other_users_list = $myClass->pushQuery("name, user_type, unique_id, item_id, phone_number, class_id", "users", "client_id='{$params->clientId}' AND user_status IN ({$myClass->default_allowed_status_users_list}) AND status='1' ORDER BY name LIMIT {$myClass->global_limit}");
                    ...
                    <div class="card">
                        <div class="card-body" id="message_form">
                            ...
                            <div class="form-group mb-1">
                                ...
                                <textarea data-route="'.$route.'" maxlength="480" id="message_textarea" name="message" style="height:200px" class="form-control"></textarea>
