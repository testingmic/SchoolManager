...
$response->title = "Assign Student Section ";
...
$response->html = '
    <section class="section list_Students_By_Class">
        <div class="section-header">
            <h1><i class="fa fa-user-graduate"></i> Assign Student Section</h1>
        ...
        <input type="hidden" disabled name="assign_param" value="section">
        <div class="row" id="bulk_assign_department_section">
            <div class="col-12 col-sm-12 col-md-12 mb-2 text-primary">
                <h4 class="font-italic">Use this panel to assign section to a class of students.</h4>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="section_id" data-width="100%" class="form-control selectpicker">
                                <option value="">Please Select Section</option>';
                                foreach($sections_list as $each) {
                                    $response->html .= "<option data-section_name='{$each->name}' value=\"{$each->id}\">".strtoupper($each->name)."</option>";
                                }
                                $response->html .= '
                            </select>
                        </div>
                        ...
                        <div class="form-group" align="right" id="allocate_fees_button">
                            <button type="submit" disabled="disabled" onclick="return save_Section_Department_Allocation(\'section\')" class="btn btn-outline-success"><i class="fa fa-save"></i> Assign Section</button>
                        </div>
