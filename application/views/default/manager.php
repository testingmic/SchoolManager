        ...
        $import_div .= "
            <div class=\"col-lg-4\">
                <div class=\"form-group\">
                    ...
                    <input ".($key === "students" ? "checked disabled='disabled'" : "checked")." id=\"{$key}_{$count}\" style=\"height:20px;width:20px;\" class=\"cursor data_to_import\" name=\"data_to_import[]\" value=\"{$key}\" type=\"checkbox\">
                </div>
            </div>";
    }
