...
global $myClass, $isTutor, $isParent, $defaultUser, $isAdmin;
...
$pageTitle = "Weekly Staff Reports";
...
foreach($reports as $key => $each) {
    ...
    // set the url link
    $url_link = "staff_weekly_reports/{$each->item_id}";
    ...
    <section class="section">
            ...
            <div class="section-header-breadcrumb">
                ...
                '.(!empty($report_id) ? 
                    "<div class='breadcrumb-item'>
                        <a href='{$baseUrl}staff_weekly_reports'>{$pageTitle}</a>
                    </div>
        ...
        <div class="row" id="filter_Department_Class">';
            ...
            if(empty($report_id)) {
                // content to display
                $response->html .='
                <div class="'.($isTutorAdmin ? "col-12 col-md-12" : "col-12 col-md-12").'">
                    <div class="card">
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="font-17 text-uppercase mb-2">
                                ...
                                <span onclick="return load(\'staff/'.$data->student_id.'\')" class="user_name">'.$data->student_name.'</span>
                            </div>
                            <div class="font-17 text-uppercase mb-2">
