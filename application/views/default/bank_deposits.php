...
$filter = (object) $_GET;
$pageTitle = "Accounting - Bank Deposits";
$response->title = $pageTitle;

// permission to modify and validate
$incomePermission = $accessObject->hasAccess("deposits", "accounting");
...
foreach($list_data as $key => $each) {
    ...
    $type_list .= "<td><span class='badge badge-success'>".($each->transaction_type)."</span></td>";
    ...
    <section class="section">
        ...
        <div class="row">
            ...
            <div class="col-12 '.($canDeposit ? "col-md-7 col-lg-8" : "col-md-12").'">
                ...
                <div class="card">
                    <div class="card-header"><i class="fa fa-list"></i> &nbsp; Bank Deposits List</div>
                    <div class="card-body">
