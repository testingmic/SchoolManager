...
if ( ! function_exists('send_email'))
{
	...
	function send_email($_recipients, $_subject, $_message, $name=NULL, $cc = NULL) {
		...
		// send the email
		require "C:\\xampp\htdocs\\analitica_innovare\\followin\\system\\libraries\\Phpmailer.php";
		require "C:\\xampp\htdocs\\analitica_innovare\\followin\\system\\libraries\\Smtp.php";
		...
		$config = (Object) array(
			'subject' => $subject,
			'headers' => "From: (Followin - Analitica Innovare) <info@analiticainnovare.com> \r\n Content-type: text/html; charset=utf-8",
			'Smtp' => true,
		...
		$mail->setFrom('no-reply@analiticainnovare.net', 'Followin - Analitica Innovare');
