 ...
 * @return String
 */
function no_record_found($title = null, $caption = null, $url_link = null, $record = null, $no_button = false, $icon = "fa-search", $div_class = false) {
    $html = "";
    $html .= !empty($div_class) ? "<div class='col-lg-12 mb-3 col-md-12'>" : null;
    $html .= "
    <div id='no_record_found_container' class='backdrop-blur-xl w-full ".($no_button ? "mt-2" : null)." backdrop-saturate-150 rounded-2xl border border-solid-gray dark:bg-opacity-20 transition-all duration-300 p-6 bg-white dark:bg-gray-900/50 border-white/10 dark:border-gray-700/50'>
...
function academic_term_ended_notification($defaultAcademics, $baseUrl) {
    return '
    <div class="flex p-3 bg-red-50 dark:bg-red-200 rounded-xl border border-red-200 dark:border-red-800 mb-3 text-center font-19">
        <div class="flex-shrink-0 mr-3">
            <svg class="w-10 h-7 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z"></path>
            </svg>
        </div>
        <p class="text-red-700 w-100">
