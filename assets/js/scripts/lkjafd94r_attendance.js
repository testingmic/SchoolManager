        ...
        if(!attendance_array.length) {
            $(`div[id="pickCalendarActionModal"] div[class~="modal-body"]`).html(`
                <div class="font-italic text-center">
                    ...
                    <div class="mt-3">
                        <button data-dismiss="modal" onclick="return redirect_btnClicked('http://localhost/myschool_gh/attendance_log?date=${this_date}', 'pickCalendarActionModal');" class="btn btn-outline-success">Log Attendance</button>
                    </div>
                </div>
            `);
        }
